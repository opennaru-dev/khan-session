 ...
 */
public class HotrodVersion {

    protected static HotrodVersion version = null;
    protected static Properties properties = null;

    public static HotrodVersion getInstance() {
        if( version == null ) {
            try {
                version = new HotrodVersion();
                InputStream in = Thread.currentThread().getContextClassLoader().getResourceAsStream("version-hotrod.properties");
