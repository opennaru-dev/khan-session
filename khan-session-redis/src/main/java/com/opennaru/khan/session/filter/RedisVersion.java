...
public class RedisVersion {
    protected static RedisVersion version = null;
    protected static Properties properties = null;


    public static RedisVersion getInstance() {
        if( version == null ) {
            try {
                version = new RedisVersion();
                InputStream in = Thread.currentThread().getContextClassLoader().getResourceAsStream("version-redis.properties");
