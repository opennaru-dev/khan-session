 ...
 */
public class InfinispanLibVersion {
    protected static InfinispanLibVersion version = null;
    protected static Properties properties = null;


    public static InfinispanLibVersion getInstance() {
        if( version == null ) {
            try {
                version = new InfinispanLibVersion();
                InputStream in = Thread.currentThread().getContextClassLoader().getResourceAsStream("version-infinispan.properties");
